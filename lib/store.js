...
export function loadDb(){
  ...
  try {
    ...
    // Clean up any previously auto-loaded sample data so the app starts empty.
...
// Local calendar date (NOT UTC) so "today" matches the user's clock, avoiding
// off-by-one ("tomorrow") errors in the evening for timezones behind UTC.
